var config = {
    ...
    dustThreshold: new JSBigInt('10000000'),//10^7 (for sumo) used for choosing outputs/change - we decompose all the way down if the receiver wants now regardless of threshold
    txChargeRatio: 0.5,
    defaultMixin: 48, // (ring size 49)
    txChargeAddress: '',
    idleTimeout: 30,
